...
3. Is the recoverable baseline complete or only partial?
4. Is the working tree clean?
5. Are there user-owned or unclear uncommitted changes?
6. If Git is unavailable or insufficient, is there another approved backup path?
...
- Partial recovery + high-risk work -> explain what can and cannot be restored, then ask the user first
